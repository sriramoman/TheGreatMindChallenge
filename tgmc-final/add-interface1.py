...
class HellowWorldGTK:
	...
	def ins(self,widget,i):
		...
		if search(listzone,entryzone.get_text()) == False:
			...
			lzd[entryzone.get_text()] = gtk.ListStore(gobject.TYPE_STRING)
			lzd[entryzone.get_text()].set_sort_column_id(0,gtk.SORT_ASCENDING)
		if search(lzd[entryzone.get_text()],entrystop.get_text()) == False:
